    ...
    <Page>
      ...
      <div className="container">
        <Container>
          <div>
            <h2>DESCRIÇÃO</h2>
            <br />O indicador, criado em parceria pelo Instituto Federal de
            Alagoas, Transparência Brasil e Universidade Federal de Campina
            Grande, avalia a transparência da remuneração do sistema de Justiça
            em duas dimensões: completude das informações e facilidade de coleta
            e análise de dados abertos.
            <br />
            <br /> Quanto à completude, há seis critérios para avaliar a
            ...
            <br />
            <br /> Na dimensão de facilidade do Índice, há cinco critérios para
      ...
      <div className="container">
        <Container>
          <div>
            <h2>METODOLOGIA</h2>
            <br />
            Inicialmente calcula-se, para cada mês do período avaliado, a média
            simples da pontuação que o órgão alcançou tanto na dimensão de
            completude quanto na de facilidade.
            <br />
            <br /> Na maioria dos critérios avaliados nas dimensões, o órgão
            pode pontuar 0 ou 1. Nos critérios remuneração básica, outras
            receitas, detalhamento de despesas e formato de acesso, a escla é
            contínua com pontuações entre 0 e 1. Ainda que haja seis critérios
            na dimensão de completude e cinco na de facilidade, cada dimensão
            tem peso idêntico.
            <br />
            <br /> A{' '}
            <Link href="https://pt.wikipedia.org/wiki/Média_harmônica">
              média harmônica
            </Link>{' '}
            ...
            que 0 representa o ente menos transparente e 1, o mais transparente.
            A média harmônica pondera as duas dimensões de maneira que se uma
            delas tiver valor próximo a zero, o índice também terá valor próximo
            a zero.
            <br />
            <br /> Como o período avaliado corresponde a quantidade de meses, o

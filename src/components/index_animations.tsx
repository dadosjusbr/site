...
export const Animation1 = React.forwardRef<HTMLSpanElement>((props, ref) => (
  <Animation1Context ref={ref}>
    <img
...
`;
const Animation2Context = styled(Context)`
...
`;
const Animation3Context = styled(Context)`
...
`;
const Animation4Context = styled(Context)`

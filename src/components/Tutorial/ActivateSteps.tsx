...
import { Step, StepLabel, Typography, Link } from '@mui/material';
  ...
  },
  {
    ...
    subtitle: (
      <>
        ...
        <Subtitle>
          Para isso, vamos até a seção "baixar um subconjunto desses dados",
          onde podemos selecionar meses e tipos de remuneração específicos. A
          plataforma mostra uma visualização rápida das 100 primeiras linhas da
          planilha.
        </Subtitle>
      </>
    ),
